...
int main( int argc, char *argv[] )
{
   ...
   while( true ) // ciclo principal
   {
      ...
      for( int i = 1 ; i <= 4 ; i++ ) // ciclo secundario (4 iteraciones)
      {
         ...
         if(steady_clock::now()-ini_sec >  milliseconds( 10)){
            cout << "Se ha superado el tiempo limite." << endl;
            exit(-1);
            }
      }
   }
...
//El minimo tiempo de espera es de 10 milisegundos


//Pregunta 2

//Seria planificable siempre el el sleep_for de las tareas nos devolviera el control directamente despues de acabar
// su tiempo, si no podemos asegurar eso y no seria posbile panificarlo ya que un minimo retraso no nos dejaria
